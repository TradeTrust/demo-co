...
const certificate = {
    ...
    "data": {
        ...
        "$template": {
            ...
            "url": "292fd2f6-9062-4555-858c-489857f12157:string:http://localhost:3000/rederer"
        },
        "description": "9ffd40ae-4c27-4944-aa4d-cf037ef5557c:string:A Certificate",
        "issuedOn": "b264599b-f91d-44f7-b15b-6def5ed8a5a8:string:2018-08-30T00:00:00+08:00",
        "certificateType": "87286159-9b9e-452d-8779-7c1f86bb4132:string:Certificate of Origin",
        "issuers": [
            {
                "name": "4b51ba42-8ece-4db3-9ced-a62a1d039259:string:DEMO STORE",
                "address": "db24a0c6-58ee-4709-813c-a571a29dc6f5:string:Changi Singapore -123456",
                "country": "8db25bcf-28fc-4a62-85d2-841057df32d5:string:Singapore",
                "certificateStore": "322795af-82ed-4a9f-8c48-c3db8a199fc5:string:0x9178F546D3FF57D7A6352bD61B80cCCD46199C2d"
            }
        ],
        "recipient": {
    ...
    "signature": {
        ...
        "targetHash": "6bb53c8335699ae8456890a9c0817b4a271790a2d7ecf2f2d8c3b430a92e5de1",
        "proof": [],
        "merkleRoot": "6bb53c8335699ae8456890a9c0817b4a271790a2d7ecf2f2d8c3b430a92e5de1"
    }
}
...
class IframeRender extends LitElement {
    ...
    render() {
        return html`
            <button id="render-certificate" @click=${() => this.renderCertificate(certificate)}>
            Render Certificate
        </button>
